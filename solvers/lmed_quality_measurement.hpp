#ifndef OPEN_SFM_METU_SOLVERS_LMED_QUALITY_MEASUREMENT_HPP
#define OPEN_SFM_METU_SOLVERS_LMED_QUALITY_MEASUREMENT_HPP
...
class LmedQualityMeasurement : public QualityMeasurement {
	...
	public:
		...
		explicit LmedQualityMeasurement(const int min_sample_size) : min_sample_size_(min_sample_size) {}
	...
	private:
		...
		double CalculateMedianOfSquaredResiduals(const std::vector<double>& residuals) {
...
#endif // OPEN_SFM_METU_SOLVERS_LMED_QUALITY_MEASUREMENT_HPP